...
// Наблюдатель за изменениями файлах
function watcher () {
...
// Запуск создания спрайтов ( npm run svgSprive )
export { svgSprive };
...
// Запуск сценарие разработчика "npm run dev"
// Запуск сценария production "npm run build"
